...
## 🛠 Funcionalidades na Loja Online
- [Registo] criação de database de email de contacto que poderá ser usado para informar da agenda de espetáculos e para contactos de merchandising como venda de t-shirts, etc...
